 ...
 */class tC extends tx{constructor(t){if(super(t),this.it=te,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===te||null==t)return this._t=void 0,this.it=t;if(t===tt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}tC.directiveName="unsafeHTML",tC.resultType=1;const tP=(...t)=>({_$litDirective$:tC,values:t});class tU extends t_{static{this.styles=f`
  ...
  `}render(){return X`
    ...
    `}constructor(...t){super(...t),this.debugMode=!1,this.toggleSpec=!1}}n([tA({type:Boolean})],tU.prototype,"debugMode",void 0),n([tA({type:Object})],tU.prototype,"spec",void 0),n([tS()],tU.prototype,"toggleSpec",void 0),tU=n([tm("pinnable-renderer")],tU);var tk={};e(tk,"PinnableEditor",()=>tN);var tT={};e(tT,"PinnableKind",()=>s),(i=s||(s={}))[i.DEFAULT=0]="DEFAULT";const tO={kind:s.DEFAULT,transform:{w:320,h:240},html:"",styles:""};class tN extends t_{static{this.styles=f`
    :host {
      display: flex;
      flex-direction: row;
      width: 100%;
  ...
  `}render(){return X`
      ...
      ></textarea>
    `}_onChange(t){this._updateSpecFromEditor(),this.dispatchEvent(new CustomEvent("change",{detail:this.spec,bubbles:!0,composed:!0}))}_onKeyDown(t){"Tab"===t.key&&(this.editor.setRangeText("  ",this.editor.selectionStart,this.editor.selectionEnd,"end"),t.preventDefault()),t.ctrlKey&&"s"===t.key&&(this._commit(),t.preventDefault()),t.ctrlKey&&"d"===t.key&&(this._delete(),t.preventDefault())}_updateSpecFromEditor(){this.message="";try{this.spec=JSON.parse(this.editor.value)}catch(t){this.message=t,console.warn("Error on editing pinnable spec:",t)}}_commit(){this._updateSpecFromEditor(),this.message="Saved!",this.dispatchEvent(new CustomEvent("commit",{detail:this.spec,bubbles:!0,composed:!0}))}_delete(){this.dispatchEvent(new CustomEvent("delete",{detail:this.spec,bubbles:!0,composed:!0}))}constructor(...t){super(...t),this.spec=tO}}n([tw("textarea.editor")],tN.prototype,"editor",void 0),n([tA({type:Object})],tN.prototype,"spec",void 0),n([tS()],tN.prototype,"message",void 0),tN=n([tm("pinnable-editor")],tN),t(u,o),t(u,tk),t(u,tT);var tM={};e(tM,"BoardPersistenceService",()=>tR),e(tM,"Board",()=>tH);class tR{constructor(t){this.key=t}save(t){console.debug(`Saving pinnable specs from key ${this.key}`,t),localStorage.setItem(this.key,JSON.stringify(t))}load(){try{let t=localStorage.getItem(this.key);if(!t)throw Error(`missing key for key ${this.key}`);return JSON.parse(t)}catch(t){console.error(`Error loading saved pinnable specs from key: ${this.key}`)}return null}reset(){localStorage.clear()}}class tH extends t_{static{this.styles=f`
    :host {
      display: flex;
  ...
  `}connectedCallback(){super.connectedCallback(),this.specs=this.storage.load()??this.specs}render(){return X`
      ...
      ${this.specs.map(t=>X`<pinnable-renderer
            class="pinnable"
            id=${t.id}
            style="${this._transformToStyles(t)}"
            .spec=${t}
...
//# sourceMappingURL=index.14e5037c.js.map
